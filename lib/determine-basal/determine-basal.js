...
// Calculate carbsReq (carbs required to avoid a hypo)
    ...
    // Note: this is an extra output that we're including just to
    // help debug our implementation of the enableSMB logic, it
    // isn't present in standard trio-oref
    rT.enableSMB = enableSMB;
