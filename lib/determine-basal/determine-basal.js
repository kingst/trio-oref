...
// Initialize and calculate variables used for predicting BGs
    ...
    // BUG: Adding precision to rounding to deal with small floating point errors
    ci = round(round(minDelta - bgi, 6),1);
    var uci = round(round(minDelta - bgi, 6),1);
    ...
    if (meal_data.carbs) {
        ...
        // BUG: Adding precision to rounding
        remainingCATime = round(round(remainingCATime, 7),1);
