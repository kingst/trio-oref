...
//console.error(glucose_data[i].glucose, bgTime, Math.round(hoursAfterMeal*100)/100, bucketed_data[bucketed_data.length-1].display_time);
    ...
    for (i=0; i < bucketed_data.length-3; ++i) {
        ...
        // This is fixing a bug where the JS used to mutate inputs
        // via changing iob_inputs, which impacted future find_insulin
        // calls in unexpected ways.
        var originalClock = iob_inputs.clock;
        ...
        iob_inputs.clock = originalClock;
